...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const entries: { path: string; priority: number }[] = [
    ...
    ...SERVICE_TYPES.map((s) => ({ path: `/firmenverzeichnis/${s.slug}`, priority: 0.78 })),
    ...
    { path: "/blog/neukunden-handwerksbetrieb", priority: 0.8 },
    { path: "/blog/telefonakquise-b2b-leitfaden", priority: 0.8 },
    { path: "/blog/angebot-schreiben-dienstleister", priority: 0.8 },
