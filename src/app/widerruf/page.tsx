...
export default function WiderrufPage() {
  return (
    <LegalShell title="Widerrufsbelehrung">
      ...
      <P>
        Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (Seciora GbR i.G., Cihan Yildirim und Salih Aygün,
        Rathenaustraße 135, 51373 Leverkusen, E-Mail: personal@lupen-rhein.de, Telefon: +49 15566 021171) mittels einer
      ...
      <UL items={[
        "An: Seciora GbR i.G., Cihan Yildirim und Salih Aygün, Rathenaustraße 135, 51373 Leverkusen, E-Mail: personal@lupen-rhein.de",
